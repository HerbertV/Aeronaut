...
package as3.aeronaut.print.aircraft
{
	...
	/**
	 * =========================================================================
	 * Class AbstractPrintPageSmallAircraft
	 * =========================================================================
	 ...
	 *  - containerSquadLogo
	 */
	dynamic public class AbstractPrintPageSmallAircraft
			...
			implements ICSPrintPageAircraft
	{
		 ...
		 * =====================================================================
		 */
		public function AbstractPrintPageSmallAircraft()
		{
			super();
		}
		 ...
		 * ---------------------------------------------------------------------
		 */
		protected function initPilot():void
		{
			...
			var copilot:Pilot = SheetAircraft(this.mySheet).getCoPilot();
			if( copilot != null ) {
		 ...
		 * ---------------------------------------------------------------------
		 */
		protected function initMaxSpeed():void
		{
		 ...
		 * ---------------------------------------------------------------------
		 */
		protected function initAccel():void
		{
		 ...
		 * @return
		 */
		protected function initSpecialCharacteristics():Array
		{
